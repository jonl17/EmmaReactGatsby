...
class ThemeUpdateChecker {
    ...
    public function installHooks(){
				$shouldCheck = apply_filters( 'tuc_check_now', $this->enableAutomaticChecking );
				if ($shouldCheck) {
    ...
    public function checkForUpdates(){
        ...
        if($update instanceof ThemeUpdate){
            update_option('lay_latest_version_kernl', $update->version);
        }
