...
class Gridder{
	...
	public function gridder_styles() {
		...
		if ( $screen->id == 'edit-category' || $screen->id == 'post' || $screen->id == 'page' ) {
			...
			wp_enqueue_style( 'gridder-iris', Setup::$uri.'/assets/css/iris.css', array(), Setup::$ver );
		}
	}
	...
	public function gridder_scripts() {
		...
		if ( $screen->id == 'edit-category' || $screen->id == 'post' || $screen->id == 'page' ) {
			...
			wp_enqueue_script( 'vendor-react', Setup::$uri.'/gridder/assets/js/react.min.js', array(), Setup::$ver );
			wp_enqueue_script( 'vendor-react-dom', Setup::$uri.'/gridder/assets/js/react-dom.min.js', array('vendor-react'), Setup::$ver );
			wp_enqueue_script( 'vendor-redux', Setup::$uri.'/gridder/assets/js/redux.min.js', array(), Setup::$ver );
			wp_enqueue_script( 'vendor-react-redux', Setup::$uri.'/gridder/assets/js/react-redux.min.js', array('vendor-redux', 'vendor-react'), Setup::$ver );
			wp_enqueue_script( 'vendor-redux-thunk', Setup::$uri.'/gridder/assets/js/redux-thunk.min.js', array('vendor-redux'), Setup::$ver );
			...
			$plugins = array(
				'layThemeCarousel' => is_plugin_active( 'laytheme-carousel/laytheme-carousel.php' ),
