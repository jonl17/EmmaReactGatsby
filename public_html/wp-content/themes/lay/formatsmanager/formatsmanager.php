...
class FormatsManager {
	...
	public static function init(){
		...
		add_action( 'wp_head', 'FormatsManager::frontend_textformats_css' );

		add_action( 'admin_init', 'FormatsManager::register_lay_iris' );
	}
	...
	public static function register_lay_iris(){
		// using modified version of iris to prevent scrolling when user drags inside colorpicker
		wp_register_script( 'lay-formatsmanager-iris', Setup::$uri."/formatsmanager/assets/js/vendor/iris.js", array( 'jquery-ui-widget', 'jquery-ui-draggable', 'jquery-ui-slider', 'jquery-touch-punch', 'jquery-color' ), '1.0.7' );
	}

	public static function formatsmanager_scripts($hook){
		if ( $hook == 'toplevel_page_manage-textformats' ) {
			wp_enqueue_script( 'plugin-bootstrap', Setup::$uri."/assets/bootstrap/js/bootstrap.min.js", array( 'jquery' ), '1.0');
			wp_enqueue_script( 'plugin-parsley', Setup::$uri."/assets/js/vendor/parsley.js", array( 'jquery' ), '1.0');

			wp_enqueue_script( 'formatsmanager-app', Setup::$uri."/formatsmanager/assets/js/formatsmanager.app.min.js", array( 'jquery', 'lay-formatsmanager-iris', 'underscore', 'backbone', 'json2', 'wp-color-picker', 'marionettev2' ), Setup::$ver);
		}
	}
