...
$lay_mobile_detect = new Mobile_Detect;
...
function laytheme_load_plugins(){
	if ( ! class_exists( 'WP_REST_Controller' ) ) {
		include_once(get_template_directory().'/assets/plugins/rest-api/plugin.php');
	}
	if(is_admin()){
		...
		if(!class_exists('Radio_Buttons_for_Taxonomies')){
			include_once(get_template_directory().'/assets/plugins/radio-buttons-for-taxonomies/radio-buttons-for-taxonomies.php');
		}
