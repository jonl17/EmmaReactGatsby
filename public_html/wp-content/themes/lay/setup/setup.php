...
class Setup{
	...
	public function __construct(){
		...
		add_action( 'wp_enqueue_scripts', array( $this, 'add_default_stylesheet' ), 100 );
		...
		add_filter( 'contextual_help', array( $this, 'lay_remove_help' ), 999, 3 );
	...
	public static function register_marionette(){
		...
		wp_register_script( 'marionettev3', Setup::$uri.'/assets/js/vendor/marionettev3/backbone.marionette.min.js' );
	}
	...
	public static function update_lay_theme_nag() {
		...
		if( $canUpdate && version_compare($newVersion, Setup::$ver, '>') ){
			...
			if ( current_user_can('update_core') ) {
				$msg = sprintf( __('Lay Theme Update Available! <a target="_blank" href="http://laytheme.com/version-history.html">View version %1$s details</a> or <a href="%2$s">update here</a>.'), $newVersion, network_admin_url( 'themes.php' ) );
	...
	public static function show_made_with_lay_notice(){
  	...
  	public static function lay_remove_help($old_help, $screen_id, $screen){
	...
	public static function laytheme_admin_footer_text($text) {
	  echo $text.' <span style="font-style: italic;">Need help? <a target="_blank" href="http://laytheme.com/documentation.html">Visit Lay Theme Documentation</a>. Lay Theme by <a target="_blank" href="http://arminunruh.com">Armin Unruh</a>.</span>';
	}
	...
	public static function add_default_stylesheet(){
		wp_enqueue_style( 'css-root-style', get_stylesheet_uri() );
	}
