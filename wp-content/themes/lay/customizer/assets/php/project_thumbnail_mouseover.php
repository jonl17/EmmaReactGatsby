...
$wp_customize->add_control(
    new WP_Customize_Control(
        ...
        array(
            ...
            'type'           => 'radio',
            'priority'       => 40,
            'choices'        => array('mo_dont_show' => 'Do not show mouseover state', 'mo_always' => 'Always show mouseover state', 'mo_on_tap' => 'Show mouseover state on tap, tap again to enter project')
        )
    )
);
