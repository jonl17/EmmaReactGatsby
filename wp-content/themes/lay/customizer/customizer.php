...
class Customizer{
	...
	public static function lay_customize_register($wp_customize){
		...
		$wp_customize->add_panel( 'mobile_panel', array(
			...
			'description' 	 => 'Click on the small smartphone icon below to see the mobile version. Or resize your browser so the preview area is less than '.$breakpoint.'px wide.'
		) );
