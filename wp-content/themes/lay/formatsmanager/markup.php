...
echo
        ...
        <td class="format-preview-wrap">
            <div class="format-preview">
                ...
                <div class="js-desktop-style js-style" contentEditable="true" <%= getStyleDesktop() %>>
                    <%= showText() %>
                </div>
...
echo
            '<div class="format-preview">
                ...
                <div class="js-tablet-style js-style" contentEditable="true" <%= getStyleTablet() %>>
                     <%= showText() %>
                </div>
...
echo
            '<div class="format-preview">
                ...
                <div class="js-phone-style js-style" contentEditable="true" <%= getStylePhone() %>>
                     <%= showText() %>
                </div>
